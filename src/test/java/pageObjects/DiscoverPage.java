...
public class DiscoverPage {
    ...
    public static By divRunningIcon = By.cssSelector("[data-test-id=\"sport_jogging\"]");
    ...
    public static By dropdownRadiusDistance = By.cssSelector("[data-test-id=\"radius_dropdown\"]");
    ...
    public static By textTourTitle = By.cssSelector("[data-test-id=\"tour_title\"]");
}